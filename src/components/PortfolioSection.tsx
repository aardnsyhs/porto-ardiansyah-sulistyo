  ...
  const projects = [
    {
      ...
      description: "A comprehensive learning management system built for educational institutions with course management, student tracking, and interactive features.",
    ...
    },
    {
      ...
      description: "Full-stack restaurant management application with order processing, inventory management, and customer relationship features.",
    ...
    },
    {
      ...
      description: "Responsive portfolio website showcasing modern design principles and optimized user experience across all devices.",
    ...
    },
    {
      ...
      description: "RESTful API service with comprehensive documentation, authentication, and rate limiting for third-party integrations.",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredProjects.map((project, index) => (
              <div 
                key={project.id}
                className={`portfolio-card group fade-in fade-in-delay-${(index % 3) + 1}`}
              >
                {/* Project Image */}
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="portfolio-label text-primary">{project.category}</span>
                  </div>
